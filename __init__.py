...
fig1.plot(sentence_len, sentence_freq, color = '#006400', linestyle = '-', marker = 'o')
fig1.set_ylabel('density distribution')
fig2 = fig1.twinx()
fig2.plot(sentence_len, np.cumsum(sentence_freq), color = '#FFA500', linestyle = '-', marker = 'o')
fig2.set_ylabel('cumulative distribution')
plt.show()
