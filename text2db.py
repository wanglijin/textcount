...
def sentencecount(textstr,keycharacter):
    ...
    while index <= n:
        ...
        index += 1
    return tindex
db = pymysql.connect('localhost','root','271828','TextsCount')
cx = db.cursor()
for i in range(10,2000):
    ri = '%d'%i
    pathstr = 'Reduced\\C000008\\'+ ri + '.txt'
    sql1 = 'CREATE TABLE sentence_table' + ri
    sql2 = '''
    ...
    sql1 = 'INSERT INTO sentence_table' + ri
    sql2 = '''
    (character_count,
    word_count)
    VALUES(%s,%s);
    ...
    for j in range(0,n-1):
        ...
        if (word_count and character_count) > 0:
            ...
            sql = 'INSERT INTO sentence_table' + ri
            sql2 = '''
            (character_count,
            word_count)
            VALUES(%s,%s);
